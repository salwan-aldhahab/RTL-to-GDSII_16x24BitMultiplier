...
# Generated on: Thu Nov 06 15:07:29 EST 2025 (Thu Nov 06 20:07:29 UTC 2025)
...
set logfile fv/mult_unsigned/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mult_unsigned -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86"
set CDN_SYNTH_ROOT      "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86"
set env(CW_DIR) "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware"
set CW_DIR      "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/CMC/tools/cadence/GENUS21.17.000_lnx86/tools.lnx86/lib/chipware/sim"
}
...
add_search_path /CMC/kits/cadence/GPDK045/gsclib045_all_v4.4/gsclib045/timing -library -both
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/src/mult_unsigned.v
elaborate_design -golden -root {mult_unsigned} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mult_unsigned/fv_map.v.gz
elaborate_design -revised -root {mult_unsigned}
...
#add_name_alias fv/mult_unsigned/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.mult_unsigned.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mult_unsigned.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mult_unsigned.rtl.fv_map.rpt
